...
import { FaEdit, FaTrash, FaEye, FaRegClock, FaCheckCircle, FaTimesCircle, FaTag } from "react-icons/fa";
...
import { useDeleteContestMutation, useManageAdminContestsQuery } from "../../../redux/feature/contestHolder/contestHolderApi";
import deleteEntity from "../../../utils/deleteEntity";
import Loading from "../../../components/Loading/Loading";
import ContestUpdate from "../contestHolder/ContestUpdate";
...
const ManageContest = () => {
  ...
  const { data: contests, refetch, isLoading } = useManageAdminContestsQuery(
    {
      page: page,
      limit: 4,
    },
